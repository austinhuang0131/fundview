...
INNER JOIN ThirteenF.INDUSTRY as ind on it.CUSIP = ind.CUSIP
WHERE sub.CIK = ? AND REPORTCALENDARORQUARTER < '2022-12-31' AND (it.CUSIP  IN (
    SELECT CUSIP FROM INDUSTRY))
